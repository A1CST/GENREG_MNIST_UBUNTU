...
MNIST_HIDDEN_SIZE = 32               # Hidden layer neurons for MNIST
MNIST_POPULATION_SIZE = 200          # Population size for MNIST training
...
MNIST_CHECKPOINT_INTERVAL = 100     # Save checkpoint every N generations
